import{_ as s,c as a,o as n,U as p}from"./chunks/framework.FpOEJISx.js";const k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Tool/webpack.md","filePath":"docs/frontend/Tool/webpack.md"}'),e={name:"docs/frontend/Tool/webpack.md"},l=p(`<h2 id="webpack" tabindex="-1">webpack <a class="header-anchor" href="#webpack" aria-label="Permalink to &quot;webpack&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const path = require(&#39;path&#39;) // // 导入 node.js 中专门操作路径的模块</span></span>
