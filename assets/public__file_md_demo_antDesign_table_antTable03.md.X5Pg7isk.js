import{_ as n,c as s,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/_file/md/demo/antDesign/table/antTable03.md","filePath":"public/_file/md/demo/antDesign/table/antTable03.md"}'),l={name:"public/_file/md/demo/antDesign/table/antTable03.md"},e=p(`<h2 id="表格竖列展示-表头支持点击事件" tabindex="-1">表格竖列展示，表头支持点击事件 <a class="header-anchor" href="#表格竖列展示-表头支持点击事件" aria-label="Permalink to &quot;表格竖列展示，表头支持点击事件&quot;">​</a></h2><p><a href="https://antdv.com/docs/vue/getting-started-cn" target="_blank" rel="noreferrer">antDesign官方文档</a></p><h3 id="html" tabindex="-1">HTML <a class="header-anchor" href="#html" aria-label="Permalink to &quot;HTML&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;div&gt;</span></span>
