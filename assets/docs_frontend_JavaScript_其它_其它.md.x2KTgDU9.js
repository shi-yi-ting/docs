import{_ as n,c as s,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/JavaScript/其它/其它.md","filePath":"docs/frontend/JavaScript/其它/其它.md"}'),e={name:"docs/frontend/JavaScript/其它/其它.md"},l=p(`<h2 id="动态处理年份下拉框" tabindex="-1">动态处理年份下拉框 <a class="header-anchor" href="#动态处理年份下拉框" aria-label="Permalink to &quot;动态处理年份下拉框&quot;">​</a></h2><p>场景： 下拉框年份切换获取某年份数据时, 2022年过完, 最新的年份应当为2023, 下拉框的选项应当更新, 前端不宜写成固定的, 下拉框选项年份值应该动态获取 1.从后台数据字典获取, 弊端是需要人为更新维护 2.前端动态生成, 一下案例就是前端动态生成, 该函数需提供一个计算参考值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// vue3的方式定义变量</span></span>
