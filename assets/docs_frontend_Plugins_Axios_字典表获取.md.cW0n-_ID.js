import{_ as s,c as a,o as n,U as p}from"./chunks/framework.zpeVKxWT.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Plugins/Axios/字典表获取.md","filePath":"docs/frontend/Plugins/Axios/字典表获取.md"}'),e={name:"docs/frontend/Plugins/Axios/字典表获取.md"},i=p(`<h2 id="获取字典工具函数封装" tabindex="-1">获取字典工具函数封装 <a class="header-anchor" href="#获取字典工具函数封装" aria-label="Permalink to &quot;获取字典工具函数封装&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import { getDictionaryApi } from &#39;@/api/request.ts&#39;</span></span>
