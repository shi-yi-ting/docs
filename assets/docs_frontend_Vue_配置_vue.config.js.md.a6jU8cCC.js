import{_ as s,c as n,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Vue/配置/vue.config.js.md","filePath":"docs/frontend/Vue/配置/vue.config.js.md"}'),e={name:"docs/frontend/Vue/配置/vue.config.js.md"},l=p(`<h2 id="vue-config" tabindex="-1">vue.config <a class="header-anchor" href="#vue-config" aria-label="Permalink to &quot;vue.config&quot;">​</a></h2><p>Vue.config.js是一个可选的配置文件，如果项目的根目录存在这个文件，那么它就会被 @vue/cli-service 自动加载。 你也可以使用package.json中的vue字段，但要注意严格遵守JSON的格式来写。这里使用配置vue.config.js的方式进行处理。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const webpack = require(&#39;webpack&#39;)</span></span>
...
<span class="line"><span>        // ...</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,3),c=[l];function i(t,o,r,u,d,g){return a(),n("div",null,c)}const h=s(e,[["render",i]]);export{v as __pageData,h as default};
