import{_ as n,c as a,o as s,U as e}from"./chunks/framework.zpeVKxWT.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/demo/env/env.md","filePath":"public/static/_file/md/demo/env/env.md"}'),p={name:"public/static/_file/md/demo/env/env.md"},t=e(`<h2 id="vue3中环境变量的使用" tabindex="-1">vue3中环境变量的使用 <a class="header-anchor" href="#vue3中环境变量的使用" aria-label="Permalink to &quot;vue3中环境变量的使用&quot;">​</a></h2><h3 id="在项目根目录下新建-env-development-开发环境-内容如下" tabindex="-1">在项目根目录下新建 .env.development（开发环境） 内容如下 <a class="header-anchor" href="#在项目根目录下新建-env-development-开发环境-内容如下" aria-label="Permalink to &quot;在项目根目录下新建 .env.development（开发环境） 内容如下&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 开发环境变量的标识，这个ENV是拿不到的，这个ENV只是个标识</span></span>
