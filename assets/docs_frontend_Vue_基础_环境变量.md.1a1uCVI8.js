import{_ as n,c as a,o as s,U as e}from"./chunks/framework.zpeVKxWT.js";const m=JSON.parse('{"title":"环境变量的使用","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Vue/基础/环境变量.md","filePath":"docs/frontend/Vue/基础/环境变量.md"}'),p={name:"docs/frontend/Vue/基础/环境变量.md"},t=e(`<h1 id="环境变量的使用" tabindex="-1">环境变量的使用 <a class="header-anchor" href="#环境变量的使用" aria-label="Permalink to &quot;环境变量的使用&quot;">​</a></h1><h2 id="vue3中环境变量的使用" tabindex="-1">vue3中环境变量的使用 <a class="header-anchor" href="#vue3中环境变量的使用" aria-label="Permalink to &quot;vue3中环境变量的使用&quot;">​</a></h2><h3 id="在项目根目录下新建-env-development-开发环境-内容如下" tabindex="-1">在项目根目录下新建 .env.development（开发环境） 内容如下 <a class="header-anchor" href="#在项目根目录下新建-env-development-开发环境-内容如下" aria-label="Permalink to &quot;在项目根目录下新建 .env.development（开发环境） 内容如下&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 开发环境变量的标识，这个ENV是拿不到的，这个ENV只是个标识</span></span>
...
<span class="line"><span>},</span></span></code></pre></div><p>上面我们已经提过了，vite指令与vite build指定是对应了默认值devolepment和production，所以此处只需要指定测试与预发环境的模式。</p>`,28),l=[t];function i(o,c,d,r,u,v){return s(),a("div",null,l)}const g=n(p,[["render",i]]);export{m as __pageData,g as default};
