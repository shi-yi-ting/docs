import{_ as n,c as s,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/demo/DOM/事件冒泡.md","filePath":"public/static/_file/md/demo/DOM/事件冒泡.md"}'),l={name:"public/static/_file/md/demo/DOM/事件冒泡.md"},e=p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre></div>`,1),t=[e];function i(c,o,d,u,r,b){return a(),s("div",null,t)}const g=n(l,[["render",i]]);export{_ as __pageData,g as default};
