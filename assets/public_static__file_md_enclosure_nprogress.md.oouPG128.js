import{_ as s,c as a,o as n,U as p}from"./chunks/framework.FpOEJISx.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/enclosure/nprogress.md","filePath":"public/static/_file/md/enclosure/nprogress.md"}'),e={name:"public/static/_file/md/enclosure/nprogress.md"},r=p(`<h2 id="进度条使用" tabindex="-1">进度条使用 <a class="header-anchor" href="#进度条使用" aria-label="Permalink to &quot;进度条使用&quot;">​</a></h2><h3 id="安装依赖" tabindex="-1">安装依赖 <a class="header-anchor" href="#安装依赖" aria-label="Permalink to &quot;安装依赖&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm install nprogress</span></span></code></pre></div><h3 id="使用方式-创建一个自定义nprogress插件" tabindex="-1">使用方式-创建一个自定义NProgress插件 <a class="header-anchor" href="#使用方式-创建一个自定义nprogress插件" aria-label="Permalink to &quot;使用方式-创建一个自定义NProgress插件&quot;">​</a></h3><p>你可以创建一个自定义插件来集成NProgress到你的Vue 3应用中。创建一个新的JavaScript文件，比如<code>nprogress.js</code>，然后添加以下代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>importNProgressfrom&#39;nprogress&#39;</span></span>
