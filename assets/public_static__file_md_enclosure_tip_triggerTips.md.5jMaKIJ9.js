import{_ as s,c as n,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/enclosure/tip/triggerTips.md","filePath":"public/static/_file/md/enclosure/tip/triggerTips.md"}'),t={name:"public/static/_file/md/enclosure/tip/triggerTips.md"},l=p(`<h3 id="triggertips使用" tabindex="-1">triggerTips使用 <a class="header-anchor" href="#triggertips使用" aria-label="Permalink to &quot;triggerTips使用&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>使用前需导入组件</span></span>
