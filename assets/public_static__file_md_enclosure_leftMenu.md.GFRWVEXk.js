import{_ as n,c as s,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/enclosure/leftMenu.md","filePath":"public/static/_file/md/enclosure/leftMenu.md"}'),e={name:"public/static/_file/md/enclosure/leftMenu.md"},l=p(`<p><strong>HTML</strong></p><p>问题：不知道为啥在vitepress中使用vue组件时会出现样式乱掉的问题，在vue3项目中正常</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
