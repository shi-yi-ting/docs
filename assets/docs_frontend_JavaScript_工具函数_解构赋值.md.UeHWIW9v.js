import{_ as s,c as a,o as n,U as p}from"./chunks/framework.FpOEJISx.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/JavaScript/工具函数/解构赋值.md","filePath":"docs/frontend/JavaScript/工具函数/解构赋值.md"}'),e={name:"docs/frontend/JavaScript/工具函数/解构赋值.md"},l=p(`<h2 id="提取数据" tabindex="-1">提取数据 <a class="header-anchor" href="#提取数据" aria-label="Permalink to &quot;提取数据&quot;">​</a></h2><h3 id="简单案例" tabindex="-1">简单案例 <a class="header-anchor" href="#简单案例" aria-label="Permalink to &quot;简单案例&quot;">​</a></h3><p>先来看看如何在 JavaScript 中解构对象，可以从这个商品对象的简单示例开始。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const product = {</span></span>
