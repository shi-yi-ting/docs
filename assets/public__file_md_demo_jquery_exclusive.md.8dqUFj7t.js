import{_ as s,c as n,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/_file/md/demo/jquery/exclusive.md","filePath":"public/_file/md/demo/jquery/exclusive.md"}'),l={name:"public/_file/md/demo/jquery/exclusive.md"},t=p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>    },</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div>`,1),e=[t];function i(c,o,u,d,r,g){return a(),n("div",null,e)}const v=s(l,[["render",i]]);export{m as __pageData,v as default};
