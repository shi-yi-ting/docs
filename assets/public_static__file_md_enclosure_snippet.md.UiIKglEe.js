import{_ as s,c as n,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/enclosure/snippet.md","filePath":"public/static/_file/md/enclosure/snippet.md"}'),e={name:"public/static/_file/md/enclosure/snippet.md"},t=p(`<h3 id="组件介绍" tabindex="-1">组件介绍 <a class="header-anchor" href="#组件介绍" aria-label="Permalink to &quot;组件介绍&quot;">​</a></h3><p>主要用于代码片段的展示用；组件封装用到<code>pre</code>标签，<code>jq</code>，以及<code>syntaxy.light.min.css</code>样式</p><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h3><p>使用前对Snippet组件进行了全局注册</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
