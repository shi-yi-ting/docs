...
<span class="line"><span>},</span></span></code></pre></div><p>上面我们已经提过了，vite指令与vite build指定是对应了默认值devolepment和production，所以此处只需要指定测试与预发环境的模式。</p>`,30),l=[t];function i(o,c,r,d,u,v){return a(),n("div",null,l)}const g=s(e,[["render",i]]);export{m as __pageData,g as default};
