import{_ as s,c as n,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const v=JSON.parse('{"title":"# vite.config.js配置","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Vue/配置/vite.config.js.md","filePath":"docs/frontend/Vue/配置/vite.config.js.md"}'),e={name:"docs/frontend/Vue/配置/vite.config.js.md"},l=p(`<h1 id="vite-config-js配置" tabindex="-1"># vite.config.js配置 <a class="header-anchor" href="#vite-config-js配置" aria-label="Permalink to &quot;# vite.config.js配置&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/* eslint-disable new-cap */</span></span>
