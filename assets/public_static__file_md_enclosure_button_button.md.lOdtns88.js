import{_ as n,c as s,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/static/_file/md/enclosure/button/button.md","filePath":"public/static/_file/md/enclosure/button/button.md"}'),l={name:"public/static/_file/md/enclosure/button/button.md"},e=p(`<h2 id="自定义botton" tabindex="-1">自定义botton <a class="header-anchor" href="#自定义botton" aria-label="Permalink to &quot;自定义botton&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>使用时候添加类样式即可，如 Button White</span></span>
