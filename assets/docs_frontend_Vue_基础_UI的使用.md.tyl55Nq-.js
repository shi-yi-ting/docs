import{_ as n,c as s,o as a,U as p}from"./chunks/framework.FpOEJISx.js";const g=JSON.parse('{"title":"vue中UI组件的使用","description":"","frontmatter":{},"headers":[],"relativePath":"docs/frontend/Vue/基础/UI的使用.md","filePath":"docs/frontend/Vue/基础/UI的使用.md"}'),e={name:"docs/frontend/Vue/基础/UI的使用.md"},l=p(`<h1 id="vue中ui组件的使用" tabindex="-1">vue中UI组件的使用 <a class="header-anchor" href="#vue中ui组件的使用" aria-label="Permalink to &quot;vue中UI组件的使用&quot;">​</a></h1><h2 id="antdesign-的使用" tabindex="-1">AntDesign 的使用 <a class="header-anchor" href="#antdesign-的使用" aria-label="Permalink to &quot;AntDesign 的使用&quot;">​</a></h2><h3 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h3><p><a href="https://antdv.com/docs/vue/getting-started-cn" target="_blank" rel="noreferrer">官网链接</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm i --save ant-design-vue@4.x</span></span></code></pre></div><h3 id="注册" tabindex="-1">注册 <a class="header-anchor" href="#注册" aria-label="Permalink to &quot;注册&quot;">​</a></h3><p>使用 <code>unplugin-auto-import</code>，<code>unplugin-vue-components</code>按需自动导入</p><h4 id="安装相关依赖" tabindex="-1">安装相关依赖 <a class="header-anchor" href="#安装相关依赖" aria-label="Permalink to &quot;安装相关依赖&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm install unplugin-auto-import -D</span></span>
<span class="line"><span>npm install unplugin-vue-components -D</span></span></code></pre></div><h4 id="在vite-config-js中进行配置" tabindex="-1">在vite.config.js中进行配置 <a class="header-anchor" href="#在vite-config-js中进行配置" aria-label="Permalink to &quot;在vite.config.js中进行配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/* eslint-disable new-cap */</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>app.mount(&#39;#app&#39;)</span></span></code></pre></div><h2 id="elementui-的使用" tabindex="-1">ElementUI 的使用 <a class="header-anchor" href="#elementui-的使用" aria-label="Permalink to &quot;ElementUI 的使用&quot;">​</a></h2><h3 id="安装-1" tabindex="-1">安装 <a class="header-anchor" href="#安装-1" aria-label="Permalink to &quot;安装&quot;">​</a></h3><p><a href="https://element.eleme.cn/#/zh-CN/component/installation" target="_blank" rel="noreferrer">官网链接</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm i element-ui -S</span></span></code></pre></div><h3 id="注册-1" tabindex="-1">注册 <a class="header-anchor" href="#注册-1" aria-label="Permalink to &quot;注册&quot;">​</a></h3><p>使用 <code>unplugin-auto-import</code>，<code>unplugin-vue-components</code>按需自动导入</p><h4 id="安装相关依赖-1" tabindex="-1">安装相关依赖 <a class="header-anchor" href="#安装相关依赖-1" aria-label="Permalink to &quot;安装相关依赖&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm install unplugin-auto-import -D</span></span>
<span class="line"><span>npm install unplugin-vue-components -D</span></span></code></pre></div><h4 id="在vite-config-js中进行配置-1" tabindex="-1">在vite.config.js中进行配置 <a class="header-anchor" href="#在vite-config-js中进行配置-1" aria-label="Permalink to &quot;在vite.config.js中进行配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/* eslint-disable new-cap */</span></span>
<span class="line"><span>import path from &#39;path&#39;</span></span>
<span class="line"><span>const pathSrc = path.resolve(__dirname, &#39;src&#39;)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import AutoImport from &#39;unplugin-auto-import/vite&#39; // 按需自动导入API</span></span>
...
<span class="line"><span>    &lt;/a-popconfirm&gt;</span></span>
<span class="line"><span>&lt;/a-space&gt;</span></span></code></pre></div><h3 id="第二中导入方式" tabindex="-1">第二中导入方式 <a class="header-anchor" href="#第二中导入方式" aria-label="Permalink to &quot;第二中导入方式&quot;">​</a></h3><p><strong>1.首先在src文件夹下新建一个plugins文件夹，里面新建element.js，内容如下：</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import {</span></span>
...
<span class="line"><span>setupBaseComponents(app)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>app.mount(&#39;#app&#39;)</span></span></code></pre></div>`,36),i=[l];function t(o,c,r,u,m,d){return a(),s("div",null,i)}const E=n(e,[["render",t]]);export{g as __pageData,E as default};
