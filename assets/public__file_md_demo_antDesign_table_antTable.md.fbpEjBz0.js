import{_ as n,c as s,o as a,U as p}from"./chunks/framework.zpeVKxWT.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"public/_file/md/demo/antDesign/table/antTable.md","filePath":"public/_file/md/demo/antDesign/table/antTable.md"}'),e={name:"public/_file/md/demo/antDesign/table/antTable.md"},l=p(`<h2 id="基础使用-带复选框-带分页-带操作列" tabindex="-1">基础使用，带复选框，带分页，带操作列 <a class="header-anchor" href="#基础使用-带复选框-带分页-带操作列" aria-label="Permalink to &quot;基础使用，带复选框，带分页，带操作列&quot;">​</a></h2><p><a href="https://antdv.com/docs/vue/getting-started-cn" target="_blank" rel="noreferrer">antDesign官方文档</a></p><h3 id="html" tabindex="-1">HTML <a class="header-anchor" href="#html" aria-label="Permalink to &quot;HTML&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;div&gt;</span></span>
